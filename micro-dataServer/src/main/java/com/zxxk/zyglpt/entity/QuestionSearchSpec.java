...
public class QuestionSearchSpec {
	...
	public String toString() {
		return "QuestionSearchSpec [id=" + id + ", subjectId=" + subjectId + ", versionId=" + versionId
				+ ", textbookId=" + textbookId + ", booknode1Id=" + booknode1Id + ", booknode2Id=" + booknode2Id
				+ ", booknode3Id=" + booknode3Id + ", bkp1Id=" + bkp1Id + ", bkp2Id=" + bkp2Id + ", bkp3Id=" + bkp3Id
				+ "]";
	}
